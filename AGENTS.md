...
10. Prompt observability is mandatory: keyframe/video prompts and key generation parameters must be present in run logs, structured events, and user-facing CLI output.
